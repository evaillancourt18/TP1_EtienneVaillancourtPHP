 ...
 * @method \App\Model\Entity\Editor|bool saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 ...
 * @method \App\Model\Entity\Editor findOrCreate($search, callable $callback = null, $options = [])
 */
