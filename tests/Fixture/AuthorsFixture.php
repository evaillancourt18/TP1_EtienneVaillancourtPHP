...
class AuthorsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            ...
            'image_id' => ['type' => 'index', 'columns' => ['files_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'authors_ibfk_1' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            'authors_ibfk_2' => ['type' => 'foreign', 'columns' => ['files_id'], 'references' => ['files', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'files_id' => 1,
                'created' => '2018-09-28 14:35:53',
                'modified' => '2018-09-28 14:35:53'
            ],
        ];
        parent::init();
    }
